...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Okt 2025 pada 20.00
...
(11, '2008', '2025-10-21 17:41:18', '420642343.jpg', '1172448165.jpg', 'jual musang', 'jual aja ni 100 rb', 'Surat dicetak, bisa diambil!', 'USAHA', 3, '2025-10-22', 1);
...
('1', '1', 'Lurah', 'saumin', '2025-10-20', 'coba', 'Laki-Laki', '', 'coba', '', 'Kerja'),
('2', '2', 'Staf', 'coba', '2025-10-20', 'coba', 'Perempuan', '', 'coba', '', 'Kerja'),
('2008', '22', 'Pemohon', 'faizal ganteng ', '2025-02-22', 'tangerang ', 'Laki-Laki', 'Islam', ' ', '', 'Sekolah');
...
INSERT INTO `pengumuman` (`id`, `judul`, `isi`, `poto`) VALUES
(1, 'hari ini ada orang kecebur', 'dia lagi jalan tiba tiba kecebur got', 'contoh.jpg'),
(2, 'apa ajah ', 'faizal ganteg banget', '1462958693.jpg');
...
CREATE TABLE `profil` (
  ...
  `kontak_` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
